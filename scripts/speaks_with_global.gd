...
func _ready():
	...
	for i in range(0, 3):
		...
		Global.ecs_world.add_component(entity, "Health", (randi() % 100) + 10)
		Global.ecs_world.add_component(entity, "Collection", 1)
		Global.ecs_world.add_component(entity, "Party", 1)
	for i in range(0, 3):
		var entity = Global.ecs_world.add_entity()
		Global.ecs_world.add_component(entity, "Name", randi())
		Global.ecs_world.add_component(entity, "Speed", (randi() % 20) + 10)
		Global.ecs_world.add_component(entity, "Health", (randi() % 100) + 10)
		Global.ecs_world.add_component(entity, "Collection", 0)
		Global.ecs_world.add_component(entity, "Party", 0)
